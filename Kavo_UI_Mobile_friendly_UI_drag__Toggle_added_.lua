...
local LibName = "Kavo_UI_Frame"

function Kavo:ToggleUI()
	local pGui = game.Players.LocalPlayer:FindFirstChild("PlayerGui")
	local main = pGui and pGui:FindFirstChild(LibName)
	if main then
		main.Enabled = not main.Enabled
	else
		warn("Kavo UI frame not found in PlayerGui!") -- This helps us debug
	end
end
...
function Kavo.CreateLib(kavName, themeList)
	...
	DragDetector.Parent = pGui:WaitForChild("Kavo_UI_Frame"):FindFirstChild("Main")
	local ToggleButton = Instance.new("TextButton")
	local ScreenGui2 = Instance.new("ScreenGui")
	ScreenGui2.Name = "ToggleGui"
	ScreenGui2.Parent = pGui
	ScreenGui2.ResetOnSpawn = false
	ToggleButton.Name = "ToggleKavo"
	ToggleButton.Text = "Toggle"
	
	ToggleButton.Size = UDim2.new(0, 100, 0, 40) 
	ToggleButton.Position = UDim2.new(0.034, 0, 0.551, 0)

	ToggleButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	ToggleButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	ToggleButton.ZIndex = 10 
	ToggleButton.Parent = ScreenGui2
