...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/rafaelqcc/Other-scripts/main/Orion/Orion.lua')))()
```

Credits https://github.com/Seven7-lua
